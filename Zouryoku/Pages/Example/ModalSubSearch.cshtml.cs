...
namespace Zouryoku.Pages.Example
{
    ...
    public partial class ModalSubSearchModel : BasePageModel<ModalRegisterModel>
    {
        // ---------------------------------------------
        // 1. 定数
        // ---------------------------------------------
        ...
        public async Task<IActionResult> OnGetSearchAsync(ViewModel viewModel)
        {
            ...
            // 2 画面を表示 ///////////////////////////////////////////////////////////////////////////////
            var data = await PartialToJsonAsync("_ModalSubSearchPartial", viewModel);
