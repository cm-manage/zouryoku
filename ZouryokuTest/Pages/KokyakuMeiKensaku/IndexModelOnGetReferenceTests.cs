...
namespace ZouryokuTest.Pages.KokyakuMeiKensaku
{
    ...
    /// </summary>
    [TestClass]
    public class IndexModelOnGetReferenceTests : IndexModelTestBase
    {
        /// <summary>
        ...
        public async Task OnGetReferenceHistory_営業社員が有効_データを取得(int customerId)
        {
            // Arrange
        ...
        public async Task OnGetReferenceHistory_営業社員が有効でない_データを取得(int customerId)
        {
            // Arrange
            var model = CreateModel();
            CreateDataForSearch();
        ...
        public async Task OnGetReferenceHistory_営業社員BaseIDに対応する社員が存在しない_データを取得(int customerId)
        {
            //Arrange
            var model = CreateModel();
            CreateDataForSearch();
        ...
        /// <returns></returns>
        [TestMethod]
        public async Task OnGetReferenceHistory_対応する顧客が存在しない_データを取得しない()
        {
            //Arrange
            var model = CreateModel();
            CreateDataForSearch();
        ...
        /// <returns></returns>
        [TestMethod]
        public async Task OnGetReferenceHistory_ログインユーザーのものでない_データを取得しない()
        {
            //Arrange
            var model = CreateModel();
        ...
        /// <returns></returns>
        [TestMethod]
        public async Task OnGetReferenceHistory_取得データが参照時間の降順()
        {
            // Arrange
            var model = CreateModel();
            CreateDataForSort();
        ...
        /// <returns></returns>
        [TestMethod]
        public async Task OnGetReferenceHistory_取得データが20件()
        {
            //Arrange
            var model = CreateModel();
