...
namespace Zouryoku.Pages.JuchuJohoHyoji
{
    ...
    public class IndexModel : BasePageModel<IndexModel>
    {
        ...
        public async Task<IActionResult> OnGetAsync(long id)
        {
            ...
            await MaintainKingsJuchuSansyouRirekiAsync(db, id, LoginInfo.User.SyainBaseId);
        ...
        public class JuchuViewModel
        {
            ...
            /// 表示対象受注（エンティティ）
            /// </summary>
            public KingsJuchu? Juchu { private get; set; }
            ...
            [Display(Name = "原価凍結")]
            public string GenkaToketu => Juchu == null ? string.Empty :
                Juchu.IsGenkaToketu ? "凍結済み" : "未";
