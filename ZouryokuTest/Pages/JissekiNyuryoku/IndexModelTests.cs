...
//        {
//            var nippouData = new NippouViewModel
//            {
...
//        private static List<JissekiInputViewModel> CreateNippouAnkens(int count, int linkedCount)
//        {
//            var result = new List<JissekiInputViewModel>();
//            for (int i = 0; i < count; i++)
//            {
//                result.Add(new JissekiInputViewModel
//                {
//                    AnkensId = i + 1,
...
//            model.NippouData = new NippouViewModel
//            {
//                SyukkinHm1 = new TimeOnly(9, 0),
//                TaisyutsuHm1 = new TimeOnly(18, 0),
...
//            model.NippouAnkenCards.NippouAnkens.Add(new JissekiInputViewModel
//            {
//                AnkensId = 1,
//                AnkenName = "テスト案件",
//                IsLinked = true
...
//            model.NippouAnkenCards = new IndexModel.CardsViewModel
//            {
//                NippouAnkens = new List<JissekiInputViewModel>
//                {
//                    new JissekiInputViewModel
//                    {
//                        IsLinked = true,
//                        AnkensId = anken.Id,
//                        KokyakuKaisyaId = 1,
...
//        {
//            // 準備 (Arrange)
//            var viewModel = new NippouViewModel
//            {
//                SyukkinHm1 = new TimeOnly(9, 0),
//                TaisyutsuHm1 = new TimeOnly(18, 0)
//            };
...
//            // 実行 (Act)
//            var viewModel = JissekiInputViewModel.FromEntity(nippouAnken);
...
//            var nippou = new NippouViewModel
//            {
//                SyukkinHm1 = new TimeOnly(9, 0),
//                TaisyutsuHm1 = new TimeOnly(18, 0)
//            };
...
//            await validate.FinalConfirmValidationAsync(new List<JissekiInputViewModel>(), 0m);
...
//            var nippouAnkens = new List<JissekiInputViewModel>
//            {
//                new JissekiInputViewModel { AnkensId = anken.Id, IsLinked = true }
//            };
