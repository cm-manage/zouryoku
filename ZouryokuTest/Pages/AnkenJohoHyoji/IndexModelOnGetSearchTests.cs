...
namespace ZouryokuTest.Pages.AnkenJohoHyoji
{
    ...
    public class IndexModelOnGetSearchTests : IndexModelTestsBase
    {
        ...
        public async Task OnGetSearchAsync_存在する案件ID指定_関連データを返却(bool canAdd)
        {
            // ---------- Arrange ----------
            // シード：受注種類
            ...
            // ---------- Act ----------
            await model.OnGetSearchAsync(ankenEntity.Id, canAdd);
        ...
        public async Task OnGetSearchAsync_有効期間内の責任者_責任者名を設定(int startOffset, int endOffset)
        {
            // ---------- Arrange ----------
            // シード：責任者の社員（Syain）および SyainBase を作成（Start/End を現在に合わせる）
            SyainBasis syainBase = CreateSyainBasis(1);
            ...
            // ---------- Act ----------
            await model.OnGetSearchAsync(ankenEntity.Id, false);
        ...
        public async Task OnGetSearchAsync_有効期間外の責任者_責任者名は設定されない(int startOffset, int endOffset)
        {
            // ---------- Arrange ----------
            // シード：責任者の社員（Syain）および SyainBase を作成（Start/End を現在に合わせる）
            SyainBasis syainBase = CreateSyainBasis(1);
        ...
        // =================================================================
        [TestMethod]
        public async Task OnGetSearchAsync_KINGS受注IDがNULL_受注情報が設定されない()
        {
            // ---------- Arrange ----------
            // シード：受注種類
            var jyutyuSyurui = CreateJyutyuSyurui(1);
        ...
        // =================================================================
        [TestMethod]
        public async Task OnGetSearchAsync_受注種類IDがNULL_受注種類名が設定されない()
        {
            // ---------- Arrange ----------
            // シード：顧客会社
            var kokyaku = CreateKokyakuKaisha(1);
        ...
        // =================================================================
        [TestMethod]
        public async Task OnGetSearchAsync_顧客会社IDがNULL_顧客会社情報が設定されない()
        {
            // ---------- Arrange ----------
            // シード：受注種類
            var jyutyuSyurui = CreateJyutyuSyurui(1);
        ...
        // =================================================================
        [TestMethod]
        public async Task OnGetSearchAsync_社員BaseIDがNULL_責任者情報が設定されない()
        {
            // ---------- Arrange ----------
            // シード：受注種類
            var jyutyuSyurui = CreateJyutyuSyurui(1);
        ...
        // =================================================================
        /// <summary>
        /// 初期表示: 存在しないID指定の場合、エラーレスポンスを返却すること
        /// </summary>
        // =================================================================
        [TestMethod]
        public async Task OnGetSearchAsync_存在しない案件ID指定_エラーレスポンスを返却()
        {
            // ---------- Arrange ----------
            // シード：案件エンティティ（表示対象）
            var ankenEntity = new AnkenBuilder()
            ...
            AssertError(result, string.Format(Const.ErrorNotFound, "案件情報", nonexistentId));
        }
    }
}
