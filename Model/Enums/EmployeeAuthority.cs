...
namespace Model.Enums
{
    ...
    public enum EmployeeAuthority : int
    {
        ...
        // -----------------------------
        // 旧設定。作業者はObsolete属性の名前を確認して修正してください。
        // -----------------------------
        [Obsolete($"【変更先】{nameof(勤務日報未確定チェック)}")]
        [Display(Name = "勤務日報未確定者への通知")]
        勤務日報未確定者への通知 = 勤務日報未確定チェック,

        [Obsolete($"【変更先】{nameof(出退勤一覧の打刻位置確認)}")]
        [Display(Name = "出退勤一覧の打刻時間修正")]
        出退勤一覧の打刻時間修正 = 出退勤一覧の打刻位置確認,

        [Obsolete($"【変更先】{nameof(管理機能)}")]
